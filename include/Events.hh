...
void Events::Init(TTree *tree)
{
   ...
   if (b_btagWeight_DeepCSVB) fChain->SetBranchAddress("btagWeight_DeepCSVB", &btagWeight_DeepCSVB, &b_btagWeight_DeepCSVB);
   ...
   b_SubJet_btagCSVV2 = fChain->GetBranch("SubJet_btagCSVV2");
   if (b_SubJet_btagCSVV2) fChain->SetBranchAddress("SubJet_btagCSVV2", SubJet_btagCSVV2, &b_SubJet_btagCSVV2);
   ...
   //b_FatJet_LSmsoftdrop = fChain->GetBranch("FatJet_LSmsoftdrop"); 
   //if (b_FatJet_LSmsoftdrop){ 
  ...
  // fChain->SetBranchAddress("Photon_eCorr", Photon_eCorr, &b_Photon_eCorr);
   ...
   fChain->SetBranchAddress("Rho_fixedGridRhoFastjetCentral", &fixedGridRhoFastjetCentral, &b_fixedGridRhoFastjetCentral);
